          ...
          return (
            <div>
              <table className='table table-borderless table-hover m-0'>
                <thead className=''>
                  <tr>
                    <th className='table-danger w-25'>
                      in {list.title} list with title cards{' '}
                    </th>
                    <th scope='col' className='text-center table-info w-25'>
                      priority
                    </th>
                    <th scope='col' className='text-center table-warning w-25'>
                      Current day
                    </th>
                    <th scope='col' className='text-center table-dark'>
                      End task day
                    </th>
                  </tr>
                </thead>
